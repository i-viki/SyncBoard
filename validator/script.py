...
# Script to validate the JSON File for the SyncBoard Data
...
""" Function to Validate the Root Nodes (Board ID's) from the JSON File """
...
"""" Function to validate the Sub Nodes (Board's Data) from the JSON File """
            ...
            if isinstance(value, dict):
                ...
                if not valid_keys:
                    ...
                    if len(unexpected_keys) > 0:
                        print(f"""\nError: Unexpected key(s) found in Board ID "{key}" at file "{file_name}". \n Unexpected Keys: {unexpected_keys} """)
                        return False
    return True
...
if __name__ == '__main__':
    ...
    if root_data and sub_root_data:
        ...
        print("----------------------------------------")
        print("Board Codes Count: ", roomCodesCount)
        print("----------------------------------------")
