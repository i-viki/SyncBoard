export const frequentlyAskedQuestionsList = [
  {
  ...
  answer:
    "Yes. You can upload or paste one image per board at a time. Images are instantly shared with all participants inside the same board.",
},
{
  question: "Is there a file size limit for uploads?",
  answer:
    "Yes. Images are limited to 5MB to ensure fast synchronization and optimal performance across devices.",
},
];